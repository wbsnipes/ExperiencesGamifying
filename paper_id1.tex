...
As software development practices evolve, toolsmiths face the continuous challenge of communicating new practices and tools to the community.   We tested an idea with industrial software developers that adding game-like feedback to the development environment focused on improving practices and tool use would improve adoption of tools and practices for code navigation.  We conducted this study in three stages, the pre-study to validate our ideas, a pilot of a tool called Blaze that implements some game features to motivte better navigation practices and use of a code search tool.  We found that developers used the tool willingly and their feedback indicated the Blaze tool and game made them think about navigation practices more.  We also learned that demonstrating significant improvement can be difficult and that developers want more proactive messages and recomendations on ways they can improve.
%
