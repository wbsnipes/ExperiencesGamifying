...
\CopyrightYear{is held by the owner/author(s). Publication rights licensed to ACM.}
\crdata{978-1-4503-2768-8/14/06}
...
%Deleted the following due to Review #1 comments who concluded the paper was about improving productivity using structured navigation. After learning the new practices Sascha spends less time navigating code to accomplish his maintenance tasks.
...
\bibitem{2013Oxford}
{\em {Oxford Dictionaries Online - American English (US)}}.
\newblock Oxford University Press, 2013.

\bibitem{Beecham2008Motivation}
S.~Beecham, N.~Baddoo, T.~Hall, H.~Robinson, and H.~Sharp.
\newblock {Motivation in Software Engineering: A Systematic Literature Review}.
\newblock {\em Inf. Softw. Technol.}, 50(9-10):860--878, Aug. 2008.

\bibitem{Coman2009Casestudy}
I.~D. Coman, A.~Sillitti, and G.~Succi.
\newblock {A Case-study on Using an Automated In-process Software Engineering
  Measurement and Analysis System in an Industrial Environment}.
\newblock In {\em International Conference on Software Engineering, ICSE},
  pages 89--99. IEEE, May 2009.

\bibitem{Dubois2013Understanding}
D.~J. Dubois and G.~Tamburrelli.
\newblock {Understanding Gamification Mechanisms for Software Development}.
\newblock In {\em Foundations of Software Engineering}. ACM, 2013.
...
\bibitem{wbsnipes:Hamari2011Framework}
J.~Hamari and V.~Eranti.
\newblock {Framework for Designing and Evaluating Game Achievements}.
\newblock In {\em Digra Conference}, Sept. 2011.

\bibitem{RefWorks:118}
T.~Hill and P.~Lewicki.
\newblock {\em {Statistics: Methods and Applications}}.
\newblock StatSoft, Inc, 2007.

\bibitem{V:Johnson2007Automated}
P.~M. Johnson and H.~Kou.
\newblock {Automated Recognition of Test-Driven Development with Zorro}.
\newblock In {\em Agile Conference (AGILE)}, pages 15--25. IEEE, Aug. 2007.

\bibitem{Kou2010Operational}
H.~Kou, P.~Johnson, and H.~Erdogmus.
\newblock {Operational Definition and Automated Inference of Test-driven
  Development with Zorro}.
\newblock {\em Automated Software Engineering}, 17(1):57--85, 2010.

\bibitem{wbsnipes:MaehrCulture}
M.~Maehr.
\newblock {Culture and Achievement Motivation.}
\newblock {\em American Psychologist}, 1974(29):887--896, 1974.

\bibitem{Moser2008Case}
R.~Moser, P.~Abrahamsson, W.~Pedrycz, A.~Sillitti, and G.~Succi.
\newblock {A Case Study on the Impact of Refactoring on Quality and
...
\bibitem{Moser2006Does}
R.~Moser, A.~Sillitti, P.~Abrahamsson, and G.~Succi.
\newblock {Does Refactoring Improve Reusability?}
...
\bibitem{MurphyHill2012Improving}
...
\bibitem{V:MurphyHill2012How}
E.~Murphy-Hill, C.~Parnin, and A.~P. Black.
\newblock {How We Refactor, and How We Know It}.
\newblock {\em IEEE Transactions on Software Engineering}, 38:5--18, Jan. 2012.
...
\bibitem{wbsnipes:Robillard2004How}
M.~P. Robillard, W.~Coelho, and G.~C. Murphy.
\newblock {How Effective Developers Investigate Source Code: an Exploratory
  Study}.
\newblock {\em IEEE Transactions on Software Engineering}, 30:889--903, Dec.
  2004.

\bibitem{wbsnipes:SaatchiGameification}
{Saatchi and Saatchi S}.
\newblock Gameification for business brands and loyalty, June 2011.

\bibitem{Shepherd2012Sando}
D.~Shepherd, K.~Damevski, B.~Ropski, and T.~Fritz.
\newblock {Sando: an Extensible Local Code Search Framework}.
\newblock In {\em Foundations of Software Engineering}. ACM, 2012.

\bibitem{Singer2013a}
L.~Singer.
\newblock {\em {I}mproving the {A}doption of {S}oftware {E}ngineering
  {P}ractices {T}hrough {P}ersuasive {I}nterventions}.
\newblock PhD thesis, Gottfried Wilhelm Leibniz UniversitÃ¤t Hannover, 2013.

\bibitem{Singer2012It}
L.~Singer and K.~Schneider.
\newblock {It was a Bit of a Race: Gamification of Version Control}.
...
\bibitem{Snipes2013Towards}
W.~Snipes, V.~Augustine, A.~R. Nair, and E.~M. Hill.
\newblock {Towards Recognizing and Rewarding Efficient Developer Work
  Patterns}.
\newblock In {\em International Conference on Software Engineering}, ICSE.
  IEEE, 2013.
